            ...
            <div className="hero-content flex-col">
              <div className=" w-[550px] py-20 bg-[#F5F5F5] p-5">
                <div className="text-center lg:text-left">
                  ...
                  <p className="pb-6 text-[#707070]">Enter your Credentials to access your account </p>
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <label className="label relative">
                    <Link href="#" className="text-lg text-[#1E99F5] link link-hover absolute top-2 right-0">
                      Forgot password?
                    </Link>
                  </label>
